...
El conjunto de datos a analizar ha sido obtenido a partir de la página de Kaggle. Está compuetso por 12 columnas y 891 instancias. Entre los campos, se encuentran los siguientes:
...
## Problema que pretende responder
...
### Comprobación de la normalidad y homogeneridad de la varianza
